...
int main()
{
	...
	//wchar_t const* file_path = L"E:素材/原神/クレー/可莉2.0.pmx";
	//wchar_t const* directory_path = L"E:素材/原神/クレー/";
	...
	//wchar_t const* file_path = L"E:/素材/Tda式初音ミクV4X_Ver1.00/Tda式初音ミクV4X_Ver1.00.pmx";
	...
	//const wchar_t* motion_file_path = L"../../../3dmodel/全親での移動モーション/歩きモーション/18_スキップ（女子っぽい）【-45】.vmd";
	// const wchar_t* motion_file_path = L"../../../3dmodel/サラマンダー モーション(short)/サラマンダー モーション(short).vmd";
	const wchar_t* motion_file_path = L"E:/素材/粛聖!! ロリ神レクイエム/粛聖!! ロリ神レクイエム_サビ.vmd";
	// const wchar_t* motion_file_path = L"E:/素材/萝莉神的安魂曲_by_Sika_26cecb8a1f3d7acefad07f3e001b7fdb/五短身材（可莉）.vmd";
