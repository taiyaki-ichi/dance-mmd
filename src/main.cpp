...
int main()
{
	...
	while (dx12w::update_window())
	{
		...
		// IK
		{
			auto [center_x, center_y, center_z] = calc_transfom_matrix_2(model.bone, bone_name_to_bone_motion_data, bone_name_to_bone_index, frame_num, to_children_bone_index, L"センター");
		...
		}
		{
			...
			float3.y -= center_y;
			float3.z -= center_z;
			solve_CCDIK(model.bone, bone_name_to_bone_index[L"右つま先ＩＫ"], pmx_bone, float3, to_children_bone_index);
		}
		{
			auto [center_x, center_y, center_z] = calc_transfom_matrix_2(model.bone, bone_name_to_bone_motion_data, bone_name_to_bone_index, frame_num, to_children_bone_index, L"センター");
			...
			float3.y -= center_y;
			float3.z -= center_z;
			solve_CCDIK(model.bone, bone_name_to_bone_index[L"左足ＩＫ"], pmx_bone, float3, to_children_bone_index);
		}
		{
			auto [center_x, center_y, center_z] = calc_transfom_matrix_2(model.bone, bone_name_to_bone_motion_data, bone_name_to_bone_index, frame_num, to_children_bone_index, L"センター");
			...
			float3.y -= center_y;
			float3.z -= center_z;
			solve_CCDIK(model.bone, bone_name_to_bone_index[L"左つま先ＩＫ"], pmx_bone, float3, to_children_bone_index);
		}
